...
// Introduce a CAF_EXPORT_SYMBOL define to properly export global variables when building a shared library on Windows
...
#    if defined(_MSC_VER)
#      define CAF_EXPORT_SYMBOL __declspec(dllexport)
#    else
#      define CAF_EXPORT_SYMBOL
#    endif
#  else
#    if defined(_MSC_VER)
#      define CAF_EXPORT_SYMBOL __declspec(dllimport)
#    else
#      define CAF_EXPORT_SYMBOL
#    endif
#  endif
